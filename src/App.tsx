  ...
  const careers: Career[] = useMemo(()=>[
    {
      ...
      valueProfile: { workLifeBalance: 5, impact: 1, stability: 3, challenge: 3, income: 1, publicGood: 4 },
      skills: ["Figma", "User Research", "Prototyping"],
      salary: "연봉 3,000만원 ~ 6,500만원",
    ...
    },
    {
      ...
      valueProfile: { workLifeBalance: 4, challenge: 4, income: 2, stability: 3, impact: 1, publicGood: 2 },
      skills: ["HTML/CSS", "JavaScript", "React", "Node.js", "SQL"],
      salary: "연봉 3,500만원 ~ 7,000만원",
    ...
    },
    {
      ...
      valueProfile: { stability: 5, challenge: 5, income: 3, workLifeBalance: 2, impact: 4, publicGood: 2 },
      skills: ["AWS", "Docker", "Terraform"],
      salary: "연봉 4,500만원 ~ 9,000만원",
    ...
    },
    {
      ...
      valueProfile: { stability: 4, challenge: 5, income: 3, workLifeBalance: 2, impact: 4, publicGood: 2 },
      skills: ["CI/CD", "Docker", "Kubernetes", "Monitoring"],
      salary: "연봉 4,500만원 ~ 8,500만원",
    ...
    },
    {
      ...
      valueProfile: { challenge: 4, impact: 3, income: 4, stability: 3, workLifeBalance: 3, publicGood: 4 },
      skills: ["Python", "SQL", "ML"],
      salary: "연봉 5,000만원 ~ 10,000만원",
    ...
    },
    {
      ...
      valueProfile: { challenge: 5, income: 4, stability: 3, workLifeBalance: 2, impact: 2, publicGood: 3 },
      skills: ["TensorFlow", "PyTorch", "MLOps"],
      salary: "연봉 6,000만원 ~ 12,000만원",
    ...
    },
    {
      ...
      valueProfile: { impact: 5, workLifeBalance: 3, challenge: 2, stability: 2, income: 3, publicGood: 3 },
    ...
    },
    {
      ...
      valueProfile: { stability: 5, challenge: 4, impact: 1, workLifeBalance: 2, income: 3, publicGood: 4 },
